...
const TYPE_STYLES: Record<Library["type"], string> = {
...
export function LibrariesList({ libraries }: { libraries: Library[] }) {
    ...
    <Card>
      <CardHeader className="gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {(["runtime", "dev", "peer"] as const).map((t) => (
            counts[t] ? (
